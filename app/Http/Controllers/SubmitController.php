...
class SubmitController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'plasticType' => 'required|integer|digits_between:1,10',
            'metalType' => 'required|integer|digits_between:1,10',
            'paperType'=> 'required|integer|digits_between:1,10',
            'glassType'=> 'required|integer|digits_between:1,10',
