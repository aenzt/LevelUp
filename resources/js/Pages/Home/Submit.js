    ...
    return (
        <div className='bg-gray-200'>
            ...
            <div className="relative flex justify-center h-full bg-gray-200 dark:bg-gray-900 sm:items-center sm:pt-0">
                ...
                <div className='flex-col mx-auto flex bg-gray-200 w-full justify-center h-full lg:h-screen mt-20 lg:mt-0'>
                                ...
                                <div className="shadow overflow-hidden sm:rounded-md">
                                    <div className="px-4 py-5 bg-white sm:p-6 w-[80vw]">
                                        <div className="grid grid-cols-6 gap-6">
                                            ...
                                            <div className="col-span-6 sm:col-span-3">
                                                <label className="block text-sm font-bold text-gray-700">Delivery receipt photo</label>
                                                <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                                                    <div className="space-y-1 text-center">
                                                        <svg
                                                            className="mx-auto h-12 w-12 text-gray-400"
