...
export default function HomeMenu() {
    return (
        // <div class="h-screen hidden lg:block my-4 shadow-lg relative w-80">
            // <div class="bg-white h-screen w-80 my-4 rounded-2xl dark:bg-gray-700">
            ...
            //         </svg>
            //     </div>
            <div class="flex-shrink-0 hidden h-screen w-80 p-12 overflow-y-auto md:block">
                <nav class="mt-6">
                    <div>
